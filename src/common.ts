...
(() => {
   ...
   */
  function getNewSize(width: number): number {
   ...
   * @returns {void}
   */
  function setBlackBorder(bSize: number | string): void {
   ...
   * @returns {void}
   */
  function initBlackBorder(e: Event): void {
   ...
   * @returns {void}
   */
  function fixCardPopup(e: Event | HTMLElement): void {
   ...
   * @returns {void}
   */
  function toggleSidebarExpansions(): void {
   ...
   * @returns {void}
   */
  function setSidebarExpansions(curVal: string | number): void {
   ...
   * @returns {void}
   */
  function addExpansionLink(link: string, title: string): void {
    const pNavigationUl = document.querySelector("#p-navigation ul");
    const optionLi = document.createElement("li");
   ...
   * @returns {void}
   */
  function addExpansionSidebarLinks(): void {
    const pNavigationUl = document.querySelector("#p-navigation ul");
   ...
   * @returns {void}
   */
  function sortSortables(startsort: Element, sortby: string, sortid: string): void {
   ...
   * @returns {void}
   */
  function startSort(e: Event): void {
    let sortby = "";
    let sortid = "";
   ...
   * @returns {void}
   */
  function setCardSortBy(curVal: string | number): void {
    let actualVal: number;
    if (curVal === "cookie") {
   ...
   * @returns {void}
   */
  function changeCardSortBy(): void {
   ...
   * @returns {void}
   */
  function toggleNavboxImages(): void {
   ...
   * @returns {void}
   */
  function setNavboxImages(curVal: string | number): void {
    let actualVal: number;
    if (curVal === "cookie") {
